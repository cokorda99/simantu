...
class JenispilihanpenyakitController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/data_Pilihan_Penyakit')->with('success' , 'Data berhasil ditambah');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $model->Nama_Penyakit= $request->Nama_Penyakit;
        $model->save();
        return redirect('/data_Pilihan_Penyakit')->with('success' , 'Data berhasil diUpdate');
    ...
    public function destroy($id)
    {
        ...
        return redirect('/data_Pilihan_Penyakit')->with('success' , 'Data berhasil diHapus');
    }
}
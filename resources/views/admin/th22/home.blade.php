      ...
      <div class="col-xs-12">
        ...
        <div class="card">
          <div class="card-header">
            <div class="row">
              <div class="col-sm-6">
                <h5>Perjanjian Kinerja Tahun 2022 <span id="yKinerja"></span> </h5>
              </div>
            </div>
          </div>
          <div class="card-body">
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="table-success">Peningkatan Penyediaan Benih dan Bibit serta Peningkatan Produksi Ternak
                    </td>
                    <td>
                      <table>
                        <tr>
                  ...
                  <tr>
                    ...
                    <td class="table-success">Peningkatan Kesehatan Masyarakat Veteriner</td>
                    <td>
                      <table>
                        <tr>
                    ...
                    <td class="table-info">
                      <table>
                        <tr>
                          <td>
                            <?php echo "<script>document.writeln(tampil_totalTarget_Keamananproduk );</script>"; ?>
                            Produk
                          </td>
                        </tr>
                      </table>
                    ...
                    <td class="table-danger">
                      <table>
                        <tr>
                          <td>
                            <?php echo "<script>document.writeln(tampil_totalRealisasi_Keamananproduk );</script>"; ?>
                            Produk
                          </td>
                        </tr>
                      </table>
                    ...
                    <td class="table-secondary">
                      <table>
                        <tr>
                          <td>
                            <?php echo "<script>document.writeln(tampil_PersentaseFix_Keamananproduk);</script>"; ?>
                          </td>
                        </tr>
                      </table>
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="table-success">Peningkatan Layanan Dukungan Manajemen</td>
                    <td>
                      <table>
                        <tr>
          ...
          <div class="card-header">
            <div class="row">
              <div class="col-sm-6">
                <h5>Realisasi Serapan Angaran Tahun 2022<span id="yAnggaran"></span> </h5>
              </div>
            </div>
          </div>
          <div class="card-body">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="table-danger">Rp.
                      <?php echo "<script>document.writeln(tampil_totalRealisasi_Pengendalianpenyakit);</script>"; ?>
                    </td>
                    <td class="table-active">
                      <?php echo "<script>document.writeln(tampil_PersentaseFix_Pengendalianpenyakit);</script>"; ?>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="table-danger">Rp.
                      <?php echo "<script>document.writeln(tampil_totalRealisasi_Penyediaanbenih);</script>"; ?>
                    </td>
                    <td class="table-active">
                      <?php echo "<script>document.writeln(tampil_PersentaseFix_Penyediaanbenih);</script>"; ?>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="table-danger">Rp.
                      <?php echo "<script>document.writeln(tampil_totalRealisasi_Kesehatanventeriner);</script>"; ?>
                    </td>
                    <td class="table-active">
                      <?php echo "<script>document.writeln(tampil_PersentaseFix_Kesehatanventeriner);</script>"; ?>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="table-danger">Rp.
                      <?php echo "<script>document.writeln(tampil_totalRealisasi_Dukunganmanajemen);</script>"; ?>
                    </td>
                    <td class="table-active">
                      <?php echo "<script>document.writeln(tampil_PersentaseFix_Dukunganmanajemen);</script>"; ?>
                    </td>
                  </tr>
                </tbody>
                <tfoot>
                  <tr class="table-success">
                    ...
                    <td>Rp.
                      <?php echo "<script>document.writeln(tampil_JumlahRealisasi_Total);</script>"; ?>
                    </td>
                    <td>
                      <?php echo "<script>document.writeln(tampil_PersentaseFix_Total);</script>"; ?>
                    </td>
                  </tr>
                </tfoot>
              </table>
          ...
          <div class="card-header">
            <div class="row">
              <div class="col-sm-6">
                <h5>SDM Tahun 2022<span id="ySDM"></span></h5>
              </div>
            </div>
          </div>
          <div class="card-body">
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr class="table-warning">
                    <td>
                      <?php echo "<script>document.writeln(total_Jenis_ASN);</script>"; ?> Orang
                    </td>
                    <td>
                      <?php echo "<script>document.writeln(total_Jenis_DPK);</script>"; ?> Orang
                    </td>
                    <td>
...
var realisasibulan12_asf = parseInt(data_asf[11].Realisasi);
  ...
  var totalTarget_tampil_piphewan = parseInt(tampil_totalTarget_Rabies) + parseInt(tampil_totalTarget_Avian) + parseInt(tampil_totalTarget_Brucellosis) + parseInt(tampil_totalTarget_Anthrax) + parseInt(tampil_totalTarget_Hcholera) + parseInt(tampil_totalTarget_Penyakitlain) +  parseInt(tampil_totalTarget_Asf) + parseInt(tampil_totalTarget_Penyakitviral) + parseInt(tampil_totalTarget_Penyakitbakterial) + parseInt(tampil_totalTarget_Pmk);
...
<script>
  ...
  var total_Realisasi_Pengendalianpenyakit = 0;

  var total_Target_Penyediaanbenih = 0;
  var total_Realisasi_Penyediaanbenih = 0;

  var total_Target_Kesehatanventeriner = 0;
  var total_Realisasi_Kesehatanventeriner = 0;

  var total_Target_Dukunganmanajemen = 0;
  var total_Realisasi_Dukunganmanajemen = 0
  ...
  for (let index = 0; index < data_pengendalianpenyakit.length; index++) {
    ...
    var Realisasi_Pengendalianpenyakit = parseInt(data_pengendalianpenyakit[index].Realisasi);
    total_Target_Pengendalianpenyakit += Target_Pengendalianpenyakit;
    total_Realisasi_Pengendalianpenyakit += Realisasi_Pengendalianpenyakit;
  }
  ...
  for (let index = 0; index < data_penyediaanbenih.length; index++) {
    ...
    var Realisasi_Penyediaanbenih = parseInt(data_penyediaanbenih[index].Realisasi);
    total_Target_Penyediaanbenih += Target_Penyediaanbenih;
    total_Realisasi_Penyediaanbenih += Realisasi_Penyediaanbenih;
  }
  ...
  for (let index = 0; index < data_kesehatanventeriner.length; index++) {
    ...
    var Realisasi_Kesehatanventeriner = parseInt(data_kesehatanventeriner[index].Realisasi);
    total_Target_Kesehatanventeriner += Target_Kesehatanventeriner;
    total_Realisasi_Kesehatanventeriner += Realisasi_Kesehatanventeriner;
  }
  ...
  for (let index = 0; index < data_dukunganmanajemen.length; index++) {
    ...
    var Realisasi_Dukunganmanajemen = parseInt(data_dukunganmanajemen[index].Realisasi);
    total_Target_Dukunganmanajemen += Target_Dukunganmanajemen;
    total_Realisasi_Dukunganmanajemen += Realisasi_Dukunganmanajemen;
  }
  ...
  var tampil_totalRealisasi_Pengendalianpenyakit = formatRupiah(total_Realisasi_Pengendalianpenyakit);
  var tampil_Persentase_Pengendalianpenyakit = (parseInt(total_Realisasi_Pengendalianpenyakit) / parseInt(rata_totalTarget_Pengendalianpenyakit)) * 100;
  var tampil_PersentaseFix_Pengendalianpenyakit = tampil_Persentase_Pengendalianpenyakit.toFixed(2) + ' %';

  var tampil_totalTarget_Penyediaanbenih = formatRupiah(rata_totalTarget_Penyediaanbenih);
  var tampil_totalRealisasi_Penyediaanbenih = formatRupiah(total_Realisasi_Penyediaanbenih);
  var tampil_Persentase_Penyediaanbenih = (parseInt(total_Realisasi_Penyediaanbenih) / parseInt(rata_totalTarget_Penyediaanbenih)) * 100;
  var tampil_PersentaseFix_Penyediaanbenih = tampil_Persentase_Penyediaanbenih.toFixed(2) + ' %';

  var tampil_totalTarget_Kesehatanventeriner = formatRupiah(rata_totalTarget_Kesehatanventeriner);
  var tampil_totalRealisasi_Kesehatanventeriner = formatRupiah(total_Realisasi_Kesehatanventeriner);
  var tampil_Persentase_Kesehatanventeriner = (parseInt(total_Realisasi_Kesehatanventeriner) / parseInt(rata_totalTarget_Kesehatanventeriner)) * 100;
  var tampil_PersentaseFix_Kesehatanventeriner = tampil_Persentase_Kesehatanventeriner.toFixed(2) + ' %';

  var tampil_totalTarget_Dukunganmanajemen = formatRupiah(rata_totalTarget_Dukunganmanajemen);
  var tampil_totalRealisasi_Dukunganmanajemen = formatRupiah(total_Realisasi_Dukunganmanajemen);
  var tampil_Persentase_Dukunganmanajemen = (parseInt(total_Realisasi_Dukunganmanajemen) / parseInt(rata_totalTarget_Dukunganmanajemen)) * 100;
  var tampil_PersentaseFix_Dukunganmanajemen = tampil_Persentase_Dukunganmanajemen.toFixed(2) + ' %';
  ...
  var JumlahRealisasi_Total = total_Realisasi_Pengendalianpenyakit + total_Realisasi_Penyediaanbenih + total_Realisasi_Kesehatanventeriner + total_Realisasi_Dukunganmanajemen;
  var tampil_JumlahTarget_Total = formatRupiah(JumlahTarget_Total);
  var tampil_JumlahRealisasi_Total = formatRupiah(JumlahRealisasi_Total);
  var tampil_Persentase_Total = (parseInt(JumlahRealisasi_Total) / parseInt(JumlahTarget_Total)) * 100;
  var tampil_PersentaseFix_Total = tampil_Persentase_Total.toFixed(2) + ' %';
...
<script>
  ...
  var total_Jenis_ASN = 0;
  var total_Jenis_DPK = 0;

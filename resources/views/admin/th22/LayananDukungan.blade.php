...
<div class="content-wrapper">
  ...
  <section class="content-header mb-5">
    <h1 class="text-uppercase">
      LAYANAN DUKUNGAN MANAJEMEN INTERNAL TAHUN
      <?php ?>
    </h1>
    <p>Update at :
  ...
  <section class="content">
      ...
      <div class="col-lg-4 col-xs-6">
        ...
        <div class="small-box bg-green">
          <div class="inner">
            ...
            <p>REALISASI LAYANAN DUKUNGAN MANAJEMEN INTERNAL </p>
            <hr>
      ...
      <div class="col-lg-5">
        <div class="card">
          <div class="card-header">
            <div class="row">
              <div class="col-lg-6">
                  <h5>Data Layananan Dukungan Meananjemen Internal</h5>
              </div>
              <div class="col-lg-6">
                <div class="float-end">
    ...
    <div class="col-lg-7">
      <div class="card">
        <div class="card-header">
          <h5>Grafik Realisasi Layananan Dukungan Meananjemen Internal</h5>
        </div>
        <div class="card-body">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url('LayananDukungan') }}" method="POST">
          @csrf
...
<div class="modal fade" id="modal_edittarget" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url('LayananDukungan/1') }}" method="POST">
          @csrf
...
<div class="modal fade" id="modal_Edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url('LayananDukungan') }}" method="POST" id="editForm">
          @csrf
          {{-- {{method_field('PUT')}} --}}
          <input type="hidden" name="_method" value="PATCH">
          <div class="form-group row mb-3">
...
<script>
  var data_layanan = {!! json_encode($data_layanan -> toArray())!!};
        function updateData(id)
        {
          ...
          $('#editForm').attr('action', '/LayananDukungan/' + id)
        }
</script>
...
<script>
  ...
  var total_Realisasi = 0 ;
   for (let index = 0; index < data_layanan.length; index++) {
    var Target = parseInt(data_layanan[index].Target);
    var Realisasi = parseInt(data_layanan[index].Realisasi);
...
<script>
  ...
  document.addEventListener("DOMContentLoaded", function (event) {
    ...
    var Febuari = Januari + parseInt(data_layanan[1].Realisasi);
    var Maret = Febuari + parseInt(data_layanan[2].Realisasi);
    var April = Maret + parseInt(data_layanan[3].Realisasi);
    var Mei = April + parseInt(data_layanan[4].Realisasi);
    var Juni = Mei + parseInt(data_layanan[5].Realisasi);
    var Juli = Juni + parseInt(data_layanan[6].Realisasi);
    var Agustus = Juli + parseInt(data_layanan[7].Realisasi);
    var September = Agustus + parseInt(data_layanan[8].Realisasi);
    var Oktober = September + parseInt(data_layanan[9].Realisasi);
    var November = Oktober + parseInt(data_layanan[10].Realisasi);
    var Desember = November + parseInt(data_layanan[11].Realisasi);

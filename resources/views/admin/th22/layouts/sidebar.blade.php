<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu text-wrap px-1" data-widget="tree">
        ...
        <li><a href="/v22/PelayananKesehatanHewan" class="text-decoration-none"><i class="fa fa-book"></i> <span>Pelayanan Kesehatan Hewan</span></a></li>
        <li><a href="/v22/PengamatanPenyakitHewan" class="text-decoration-none"><i class="fa fa-book"></i> <span>Pengamatan dan Identifikasi Penyakit Hewan</span></a></li>

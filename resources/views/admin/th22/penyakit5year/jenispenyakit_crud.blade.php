  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url('data_Pilihan_Penyakit') }}" method="POST">
          @csrf
...
<div class="modal fade" id="modal_Edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url('data_Pilihan_Penyakit') }}" method="POST" id="editForm">
          @csrf
          {{-- {{method_field('PUT')}} --}}
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="{{ url('data_Pilihan_Penyakit') }}" method="POST" id="DeleteForm">
          @csrf
          {{-- {{method_field('PUT')}} --}}
...
<script>
  ...
  function updateData(id) {
    ...
    $('#editForm').attr('action', '/data_Pilihan_Penyakit/' + id)
  }
...
<script>
  ...
  function hapusData(id) {
    var result = data_penyakit5year.filter(obj => obj.id === id)[0];
    $('#DeleteForm').attr('action', '/data_Pilihan_Penyakit/' + id)
  }
</script>
...
<div class="content-wrapper">
  ...
  <section class="content">
      ...
      <div class="col-lg-4 col-xs-6">
        ...
        <div class="small-box bg-green">
          <div class="inner">
            ...
            <p>REALISASI PENYAKIT HEWAN LAINNYA</p>
            <hr>
      ...
      <div class="col-lg-5">
        <div class="card">
          <div class="card-header">
            <div class="row">
              <div class="col-lg-6">
                  <h5>Data Penyakit Hewan Lainnya</h5>
              </div>
              <div class="col-lg-6">
                <div class="float-end">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table">
                ...
                <tbody>
                  <p hidden> {{ $i = 1 }}</p>
                  @foreach ($data_penyakitlain as $key=>$value)
                  <tr>
                    <td>{{ $i++ }}</td>
                    <td>{{ $value-> Bulan}}</td>
                    {{-- <td>{{ $value-> Target}}</td> --}}
    ...
    <div class="col-lg-7">
      <div class="card">
        <div class="card-header">
          <h5>Grafik Realisasi Penyakit Hewan Lainnya</h5>
        </div>
        <div class="card-body">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url('v22/Penyakit_HewanLaninnya') }}" method="POST">
          @csrf
...
<div class="modal fade" id="modal_Edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url('v22/Penyakit_HewanLaninnya') }}" method="POST" id="editForm">
          @csrf
          {{-- {{method_field('PUT')}} --}}
          <input type="hidden" name="_method" value="PATCH">
...
{{-- MODAL EDIT --}}
<script>
  var data_pkhewan = {!! json_encode($data_penyakitlain -> toArray())!!};

...
<div class="content-wrapper">
    ...
    <section class="content-header mb-5">
        <h1 class="text-uppercase">Layanan Perencanaan dan Penganggaran {{ $tahun }}</h1>
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-xs-6">
                ...
                <div class="small-box bg-green">
                    <div class="inner">
                        ...
                        <br>
                        <p>REALISASI LAYANAN PERENCANAAN & PENGANGGARAN</p>
                        <hr>
            ...
            <div class="col-lg-4 col-xs-6">
                ...
                <div class="small-box bg-yellow">
                    <div class="inner">
                        <h5>
                            <?php echo "<script>document.writeln(tampil_PersentaseFix);</script>"; ?>
                        </h5>
                        <br>
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-6">
                                <h5>Perencanaan dan Penganggaran</h5>
                            </div>
                            <div class="col-lg-6">
                                <div class="float-end">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <p hidden> {{ $i = 1 }}</p>
                                    @foreach ($data_layananperencanaan as $key=>$value)
                                    <tr>
                                        <td>{{ $i++ }}</td>
                                        <td>{{ $value-> Bulan}}</td>
                                        {{-- <td>{{ $value-> Target}}</td> --}}
            ...
            <div class="col-lg-7">
                <div class="card">
                    <div class="card-header">
                    <h5>Grafik Realisasi Perencanaan dan Penganggaran</h5>
                    </div>
                    <div class="card-body">
  ...
  aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                ...
                <div class="modal-body">
                    <form action="{{ url('/v24/LayananPerencanaanDanPenganggaran') }}" method="POST">
                    @csrf
  ...
  aria-hidden="true">
        ...
        <div class="modal fade" id="modal_Edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-lg" role="document">
                ...
                <div class="modal-body">
                    <form action="{{ url('/v24/LayananPerencanaanDanPenganggaran') }}" method="POST" id="editForm">
                    @csrf
                    {{-- {{method_field('PUT')}} --}}
                    <input type="hidden" name="_method" value="PATCH">
...
{{-- MODAL EDIT --}}
<script>
  var data_internal = {!! json_encode($data_layananperencanaan -> toArray())!!};
        function updateData(id)
        {
          ...
          $('#editForm').attr('action', 'LayananPerencanaanDanPenganggaran')
        }
</script>

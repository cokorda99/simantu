                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <p hidden> {{ $i = 1 }}</p>
                                    @foreach ($data_layanankeuangan as $key=>$value)
                                    <tr>
                                        <td>{{ $i++ }}</td>
                                        <td>{{ $value-> Bulan}}</td>
                                        {{-- <td>{{ $value-> Target}}</td> --}}
  ...
  aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                ...
                <div class="modal-body">
                    <form action="{{ url('/v24/LayananManajemenKeuangan') }}" method="POST">
                    @csrf
  ...
  aria-hidden="true">
        ...
        <div class="modal fade" id="modal_Edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-lg" role="document">
                ...
                <div class="modal-body">
                    <form action="{{ url('/v24/LayananManajemenKeuangan') }}" method="POST" id="editForm">
                    @csrf
                    {{-- {{method_field('PUT')}} --}}
                    <input type="hidden" name="_method" value="PATCH">
...
<script>
  var data_internal = {!! json_encode($data_layanankeuangan -> toArray())!!};
        function updateData(id)
        {
          ...
          $('#editForm').attr('action', 'LayananManajemenKeuangan')
        }
</script>

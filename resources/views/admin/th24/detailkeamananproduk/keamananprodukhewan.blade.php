...
<div class="content-wrapper">
  ...
  <section class="content-header mb-5">
    <h1 class="text-uppercase">
      DATA Keamanan Produk Hewan TAHUN
      <?php echo $tahun ?>
    </h1>
    <p>Update at :
      ...
      <div class="col-lg-4 col-xs-6">
        ...
        <div class="small-box bg-green">
          <div class="inner">
            ...
            <p>REALISASI KEAMANAN PRODUK HEWAN</p>
            <hr>
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table">
                ...
                <tbody>
                  <p hidden> {{ $i = 1 }}</p>
                  @foreach ($data_keamananprodukhewan  as $key=>$value)
                  <tr>
                    <td>{{ $i++ }}</td>
                    <td>{{ $value-> Bulan}}</td>
                    {{-- <td>{{ $value-> Target}}</td> --}}
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url('v24/Keamanan_ProdukHewan') }}" method="POST">
          @csrf
...
<div class="modal fade" id="modal_Edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url('v24/Keamanan_ProdukHewan') }}" method="POST" id="editForm">
          @csrf
          {{-- {{method_field('PUT')}} --}}
          <input type="hidden" name="_method" value="PATCH">
...
{{-- MODAL EDIT --}}
<script>
  var data_pkhewan = {!! json_encode($data_keamananprodukhewan  -> toArray())!!};
        function updateData(id)
        {
          ...
          $('#editForm').attr('action', 'Keamanan_ProdukHewan')
        }
</script>

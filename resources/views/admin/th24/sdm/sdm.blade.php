        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="input-icons" style="width: 25%; float:right">
              <form action="{{ url('/v24/sdm_sdm') }}" method="GET" id="Pencarian">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url('/v24/sdm_sdm') }}" method="POST">
          @csrf
...
<div class="modal fade" id="modal_Edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url('/v24/sdm_sdm') }}" method="POST" id="editForm">
          @csrf
          {{-- {{method_field('PUT')}} --}}
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="{{ url('/v24/sdm_sdm') }}" method="POST" id="DeleteForm">
          @csrf
          {{-- {{method_field('PUT')}} --}}
...
function Pencarian() {
  $('#Pencarian').attr('action', '/v24/sdm_sdm/cari')
}
//   function myFunction() {
...
<script>
  ...
  function updateData(id) {
    ...
    $('#editForm').attr('action', '/v24/sdm_sdm/')
  }
...
<script>
  ...
  function hapusData(id) {
    ...
    $('#DeleteForm').attr('action', '/v24/sdm_sdm')
  }
</script>

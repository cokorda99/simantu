...
<div class="content-wrapper">
    ...
    <section class="content-header mb-5">
        <h1 class="text-uppercase">Layanan Pemantauan dan Evaluasi {{ $tahun }}</h1>
    ...
    <section class="content">
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <p hidden> {{ $i = 1 }}</p>
                                    @foreach ($data_layananpemantauan as $key=>$value)
                                    <tr>
                                        <td>{{ $i++ }}</td>
                                        <td>{{ $value-> Bulan}}</td>
                                        {{-- <td>{{ $value-> Target}}</td> --}}
            ...
            <div class="col-lg-7">
                <div class="card">
                    <div class="card-header">
                    <h5>Grafik Realisasi Pemantauan dan Evaluasi</h5>
                    </div>
                    <div class="card-body">
  ...
  aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                ...
                <div class="modal-body">
                    <form action="{{ url('/v24/LayananPemantauanDanEvaluasi') }}" method="POST">
                    @csrf
  ...
  aria-hidden="true">
        ...
        <div class="modal fade" id="modal_Edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-lg" role="document">
                ...
                <div class="modal-body">
                    <form action="{{ url('/v24/LayananPemantauanDanEvaluasi') }}" method="POST" id="editForm">
                    @csrf
                    {{-- {{method_field('PUT')}} --}}
                    <input type="hidden" name="_method" value="PATCH">
...
{{-- MODAL EDIT --}}
<script>
  var data_internal = {!! json_encode($data_layananpemantauan -> toArray())!!};
        function updateData(id)
        {
          ...
          $('#editForm').attr('action', 'LayananPemantauanDanEvaluasi')
        }
</script>

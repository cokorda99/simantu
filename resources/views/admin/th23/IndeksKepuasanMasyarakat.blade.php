      ...
      <div class="col-lg-4 col-xs-6">
        ...
        <div class="small-box bg-green">
          <div class="inner">
            ...
            <p>REALISASI INDEKS KEPUASAN MASYARAKAT</p>
            <hr>
      ...
      <div class="col-lg-5">
        <div class="card">
          <div class="card-header">
            <div class="row">
              <div class="col-lg-6">
                  <h5>Data Indeks Kepuasan Masyarakat</h5>
              </div>
              <div class="col-lg-6">
                <div class="float-end">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url('v23/IndeksKepuasanMasyarakat') }}" method="POST">
          @csrf
...
<div class="modal fade" id="modal_Edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url('v23/IndeksKepuasanMasyarakat') }}" method="POST" id="editForm">
          @csrf
          {{-- {{method_field('PUT')}} --}}
          <input type="hidden" name="_method" value="PATCH">
...
<script>
  ...
  var jumlahRealisasinow = 0;
   for (let index = 0; index < data_ikm.length; index++) {
    var Target = parseFloat(data_ikm[index].Target);
    var Realisasi = parseFloat(data_ikm[index].Realisasi);
...
<script>
  ...
  document.addEventListener("DOMContentLoaded", function (event) {
    ...
    var Febuari = parseFloat(data_ikm[1].Realisasi);
    var Maret = parseFloat(data_ikm[2].Realisasi);
    var April = parseFloat(data_ikm[3].Realisasi);
    var Mei = parseFloat(data_ikm[4].Realisasi);
    var Juni = parseFloat(data_ikm[5].Realisasi);
    var Juli = parseFloat(data_ikm[6].Realisasi);
    var Agustus = parseFloat(data_ikm[7].Realisasi);
    var September = parseFloat(data_ikm[8].Realisasi);
    var Oktober = parseFloat(data_ikm[9].Realisasi);
    var November = parseFloat(data_ikm[10].Realisasi);
    var Desember = parseFloat(data_ikm[11].Realisasi);

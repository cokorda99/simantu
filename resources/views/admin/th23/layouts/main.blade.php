...
<head>
  ...
  <link rel="icon" href="{{ asset('img/simantu.ico')}}"/>
  <!-- Bootstrap 3.3.7 -->
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="../assets/dist/css/AdminLTE23.min.css">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="../assets/dist/css/skins/_all-skins23.min.css">
  <!-- Morris chart -->
...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="wrapper">
    @include('admin/th23/layouts/header')
    <!-- Left side column. contains the logo and sidebar -->
    @include('admin/th23/layouts/sidebar')
    <!-- Content Wrapper. Contains page content -->
    @yield('content')
    <!-- /.content-wrapper -->
    @include('admin/th23/layouts/footer')
    <!-- ./wrapper -->

...
<div class="content-wrapper">
  ...
  <section class="content-header mb-5">
    <h1 class="text-uppercase">
      DATA PENYAKIT AVIAN INFLUENZA TAHUN
      <?php echo $tahun ?>
    </h1>
    <p>Update at :
      ...
      <div class="col-lg-4 col-xs-6">
        ...
        <div class="small-box bg-green">
          <div class="inner">
            ...
            <p>REALISASI PENYAKIT AVIAN INFLUENZA</p>
            <hr>
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table">
                ...
                <tbody>
                  <p hidden> {{ $i = 1 }}</p>
                  @foreach ($data_avian as $key=>$value)
                  <tr>
                    <td>{{ $i++ }}</td>
                    <td>{{ $value-> Bulan}}</td>
                    {{-- <td>{{ $value-> Target}}</td> --}}
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url('v23/Penyakit_Avian') }}" method="POST">
          @csrf
...
<div class="modal fade" id="modal_Edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url('v23/Penyakit_Avian') }}" method="POST" id="editForm">
          @csrf
          {{-- {{method_field('PUT')}} --}}
          <input type="hidden" name="_method" value="PATCH">
...
{{-- MODAL EDIT --}}
<script>
  var data_pkhewan = {!! json_encode($data_avian -> toArray())!!};
        function updateData(id)
        {
          ...
          $('#editForm').attr('action', 'Penyakit_Avian')
        }
</script>

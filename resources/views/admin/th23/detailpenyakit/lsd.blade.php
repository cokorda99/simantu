          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table">
                ...
                <tbody>
                  <p hidden> {{ $i = 1 }}</p>
                  @foreach ($data_lsd23 as $key=>$value)
                  <tr>
                    <td>{{ $i++ }}</td>
                    <td>{{ $value-> Bulan}}</td>
                    {{-- <td>{{ $value-> Target}}</td> --}}
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url('LSD23') }}" method="POST">
          @csrf
...
<div class="modal fade" id="modal_edittarget" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url('LSD23/1') }}" method="POST">
          @csrf
...
<div class="modal fade" id="modal_Edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url('LSD23') }}" method="POST" id="editForm">
          @csrf
          {{-- {{method_field('PUT')}} --}}
          <input type="hidden" name="_method" value="PATCH">
          <div class="form-group row mb-3">
...
{{-- MODAL EDIT --}}
<script>
  var data_pkhewan = {!! json_encode($data_lsd23-> toArray())!!};
